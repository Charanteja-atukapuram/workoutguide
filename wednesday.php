...
$exercises = [
    ...
    [
        ...
        "gif" => "https://media1.tenor.com/m/Pvlmd3Y97goAAAAC/dips-tricep.gif"
    ],
    [
        "name" => " Bicycle Crunches",
        "sets" => "12 reps",
        "description" => "Strengthens chest, shoulders, and arms. Modify by doing knee push-ups if needed.",
        "gif" => "https://media1.tenor.com/m/Jopm0JiwtdsAAAAC/egsersiz.gif"
    ],
    [
        "name" => " Leg Raises",
        "sets" => "1 minute",
        "description" => "Excellent cardio move that engages your core and gets your heart rate up.",
        "gif" => "https://media1.tenor.com/m/IDGUQ-6TBpEAAAAC/leg-lifts.gif"
    ],
