...
$exercises = [
    [
        ...
        "description" => "Emphasizes the upper chest for a fuller chest appearance.",
        "gif" => "https://media1.tenor.com/m/0VQkSuAgDNAAAAAC/bench-press-exercise.gif"
    ],
    [
        "name" => "Dumbbell Pullovers",
        "description" => "A compound movement that works both the chest and lats.",
        "gif" => "https://media1.tenor.com/m/ToAHkKHVQP4AAAAC/on-lying-triceps-al%C4%B1n-press.gif"
    ],
    [
        "name" => "T-Bar Rows",
        "description" => "Develops thickness in the mid-back and lats.",
        "gif" => "https://media1.tenor.com/m/AYJ_bNXDvoUAAAAC/workout-muscles.gif"
    ],
    [
        "name" => "Seated Dumbbell Curls",
        "description" => "Focuses on bicep growth and definition.",
        "gif" => "https://media1.tenor.com/m/SZz1gQ6iPB4AAAAC/%D9%84%D8%A7.gif"
    ],
];
